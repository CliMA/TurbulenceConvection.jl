function overwrite_namelist!(namelist, parsed_args)
    ...
    "linear_ent_biases"            => (nl, pa, key) -> (nl["turbulence"]["EDMF_PrognosticTKE"]["linear_ent_biases"] = pa[key]),
    ...
    "acnv_scaling"                 => (nl, pa, key) -> (nl["microphysics"]["microph_scaling_acsnv"] = pa[key]),
