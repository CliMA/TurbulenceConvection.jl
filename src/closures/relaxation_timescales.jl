...
function get_τ_helper(param_set::APS, microphys_params::ACMP, relaxation_timescale_type::NeuralNetworkRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, ρ::FT, w::FT, z::FT,) where {FT}
    ...
    τ_liq, τ_ice = predict_τ(ρ, T, q, w, neural_network; norm = model_x_0_characteristic) # pass in the NN and get the τs out, neural_network should be a global variable?
...
function get_N_i(param_set::APS, relaxation_timescale_type::AbstractRelaxationTimescaleType, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    N_i = get_N_i_helper(param_set, relaxation_timescale_type, q, T, p, w)
    if get_adjust_ice_N(relaxation_timescale_type)
        microphys_params::ACMP = TCP.microphysics_params(param_set)
        N_i = adjust_ice_N(param_set, microphys_params, N_i, q, T, p; r_min =  param_set.user_params.particle_min_radius)
    end
    return N_i
end

function get_N_l(param_set::APS, relaxation_timescale_type::AbstractRelaxationTimescaleType, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    return  get_N_l_helper(param_set, relaxation_timescale_type, q, T, p, w)
end
...
function get_N_i(param_set::APS, relaxation_timescale_type::AbstractRelaxationTimescaleType, ts::TD.ThermodynamicState, w::FT) where {FT}
    ...
    return get_N_i(param_set, relaxation_timescale_type, q, T, p, w)
end
...
function get_N_l(param_set::APS, relaxation_timescale_type::AbstractRelaxationTimescaleType, ts::TD.ThermodynamicState, w::FT) where {FT}
    ...
    T::FT = TD.air_temperature(thermo_params, ts)
    p::FT = TD.air_pressure(thermo_params, ts) 
    return get_N_l(param_set, relaxation_timescale_type, q, T, p, w)
end
...
get_N_i(param_set::APS, Ni::FT, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = Ni
get_N_l(param_set::APS, Nl::FT, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = Nl

# ---------------------------------------------------------------------------------------------------------------------------------------- #

# :Base
get_N_i_helper(param_set::APS, relaxation_timescale_type::BaseRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)    
get_N_l_helper(param_set::APS, relaxation_timescale_type::BaseRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)
...
get_N_l_helper(param_set::APS, relaxation_timescale_type::ExponentialTScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)

# :exponential_T_scaling_ice_raw
get_N_i_helper(param_set::APS, relaxation_timescale_type::ExponentialTScalingIceRawRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)
get_N_l_helper(param_set::APS, relaxation_timescale_type::ExponentialTScalingIceRawRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)

# :powerlaw_T_scaling_ice
function get_N_i_helper(param_set::APS, relaxation_timescale_type::PowerlawTScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    T_fr = TCP.T_freeze(param_set)
...
# :exponential_times_powerlaw_scaling_ice
get_N_i_helper(param_set::APS, relaxation_timescale_type::ExponentialTimesPowerlawScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = error("NotImplmentedError: This relaxation_timescale_type functionality has not been implemented yet")
get_N_l_helper(param_set::APS, relaxation_timescale_type::ExponentialTimesPowerlawScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = error("NotImplmentedError: This relaxation_timescale_type functionality has not been implemented yet")


# :geometric_liq__geometric_ice
function get_N_i_helper(param_set::APS, relaxation_timescale_type::GeometricLiqGeometricIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    c_1 = relaxation_timescale_type.c_1i
    c_2 = relaxation_timescale_type.c_2i
    c_3 = relaxation_timescale_type.c_3i
    return FT(c_1 * (q.ice/1e-7)^(c_2) + c_3)
end
function get_N_l_helper(param_set::APS, relaxation_timescale_type::GeometricLiqGeometricIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    c_1 = relaxation_timescale_type.c_1l
    c_2 = relaxation_timescale_type.c_2l
    c_3 = relaxation_timescale_type.c_3l
    return FT(c_1 * (q.liq/1e-5)^(c_2) + c_3)
end

# :geometric_liq__exponential_T_scaling_ice
function get_N_i_helper(param_set::APS, relaxation_timescale_type::GeometricLiqExponentialTScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    T_fr = TCP.T_freeze(param_set)
    c_1 = relaxation_timescale_type.c_1i
    c_2 = relaxation_timescale_type.c_2i
    return FT(c_1 * exp(c_2 * (T - T_fr)))
end
function get_N_l_helper(param_set::APS, relaxation_timescale_type::GeometricLiqExponentialTScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    c_1 = relaxation_timescale_type.c_1l
    c_2 = relaxation_timescale_type.c_2l
    c_3 = relaxation_timescale_type.c_3l
    return FT(c_1 * (q.liq/1e-5)^(c_2) + c_3)
...
# :geometric_liq__powerlaw_T_scaling_ice
function get_N_i_helper(param_set::APS, relaxation_timescale_type::GeometricLiqPowerlawTScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    T_fr = TCP.T_freeze(param_set)
    c_1 = relaxation_timescale_type.c_1i
    c_2 = relaxation_timescale_type.c_2i
    if T >= T_fr
...
function get_N_l_helper(param_set::APS, relaxation_timescale_type::GeometricLiqPowerlawTScalingIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    c_1 = relaxation_timescale_type.c_1l
    c_2 = relaxation_timescale_type.c_2l
    c_3 = relaxation_timescale_type.c_3l
    return FT(c_1 * (q.liq/1e-5)^(c_2) + c_3)
...
function get_N_l_helper(param_set::APS, relaxation_timescale_type::GeometricLiqExponentialTScalingAndGeometricIceRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    c_1 = relaxation_timescale_type.c_1l
    c_2 = relaxation_timescale_type.c_2l
    c_3 = relaxation_timescale_type.c_3l
    return FT(c_1 * (q.liq/1e-5)^(c_2) + c_3)
...
# :linear_combination
function get_N_i_helper(param_set::APS, relaxation_timescale_type::LinearCombinationRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    T_fr = TCP.T_freeze(param_set)
    c_1 = relaxation_timescale_type.c_1i
    c_2 = relaxation_timescale_type.c_2i
    c_3 = relaxation_timescale_type.c_3i
...
function get_N_l_helper(param_set::APS, relaxation_timescale_type::LinearCombinationRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    T_fr = TCP.T_freeze(param_set)
    c_1 = relaxation_timescale_type.c_1l
    c_2 = relaxation_timescale_type.c_2l
    c_3 = relaxation_timescale_type.c_3l
...
# :linear_combination_with_w
function get_N_i_helper(param_set::APS, relaxation_timescale_type::LinearCombinationWithWRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    T_fr = TCP.T_freeze(param_set)
    w_0 = FT(1e-3) # 1 mm/s
    c_1 = relaxation_timescale_type.c_1i
    c_2 = relaxation_timescale_type.c_2i
...
function get_N_l_helper(param_set::APS, relaxation_timescale_type::LinearCombinationWithWRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT}
    T_fr = TCP.T_freeze(param_set)
    w_0 = FT(1e-3) # 1 mm/s
    c_1 = relaxation_timescale_type.c_1l
    c_2 = relaxation_timescale_type.c_2l
...
# :neural_network
get_N_i_helper(param_set::APS, relaxation_timescale_type::NeuralNetworkRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)
get_N_l_helper(param_set::APS, relaxation_timescale_type::NeuralNetworkRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)

# :raymond_ice_test
get_N_i_helper(param_set::APS, relaxation_timescale_type::RaymondIceTestRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)
get_N_l_helper(param_set::APS, relaxation_timescale_type::RaymondIceTestRelaxationTimescale, q::TD.PhasePartition, T::FT, p::FT, w::FT) where {FT} = FT(NaN)
