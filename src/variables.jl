...
cent_aux_vars_edmf(::Type{FT}, local_geometry, edmf) where {FT} = (;
    turbconv = (;
        ...
        rhoa_tend_relax = FT(0),
        rhoa_tend_nonrelax = FT(0),
        theta_tend = FT(0),
        theta_tend_relax = FT(0),
        theta_tend_nonrelax = FT(0),
        qt_tend = FT(0), 
        qt_tend_relax = FT(0), 
        qt_tend_nonrelax = FT(0),
        mf_tend_c = FT(0),
        mf_tend_relax_c = FT(0),
        mf_tend_nonrelax_c = FT(0),
