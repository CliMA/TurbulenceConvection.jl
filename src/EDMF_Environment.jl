...
function quad_loop(en_thermo::SGSQuadrature, precip_model, vars, param_set, Δt::Real)
    ...
    UnPack.@unpack qt′qt′, qt_mean, θl′θl′, θl_mean, θl′qt′, subdomain_area, q_rai, q_sno, ρ_c, p_c, zc = vars
    ...
    @inbounds for m_q in 1:quad_order
        ...
        for m_h in 1:quad_order
            ...
            # autoconversion and accretion
            mph = precipitation_formation(param_set, precip_model, q_rai, q_sno, subdomain_area, ρ_c, zc, Δt, ts)
