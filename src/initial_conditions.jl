function initialize_edmf(edmf::EDMF_PrognosticTKE, grid::Grid, state::State, case, gm::GridMeanVariables, surf)
    initialize_env_covariance(edmf, grid, state)
...
function initialize_env_covariance(edmf::EDMF_PrognosticTKE, grid::Grid, state::State)
...
function initialize_updrafts(edmf, grid, state, gm::GridMeanVariables, surf)
...
function initialize_updrafts_DryBubble(edmf, grid, state, gm::GridMeanVariables)
