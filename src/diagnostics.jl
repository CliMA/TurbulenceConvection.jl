...
function io_dictionary_aux()
    ...
    io_dict = Dict{String, DT}(
        ...
        "updraft_et" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_bulk(state).e_tot),
        "updraft_ek" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_bulk(state).e_kin),
        "updraft_ei" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_bulk(state).e_int),
        "updraft_ht" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_bulk(state).h_tot),
        ...
        "et_mean" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_grid_mean(state).e_tot),
        "ek_mean" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_grid_mean(state).e_kin),
        "ei_mean" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_grid_mean(state).e_int),
        "ht_mean" => (; dims = ("zc", "t"), group = "profiles", field = state -> center_aux_grid_mean(state).h_tot),
